...
Dans son article fondateur, \textcite{Whittaker1960} définit la diversité $\beta$ comme le niveau de changement dans la composition des communautés, la nomme \og diversité secondaire \fg{} et lui attribue la lettre $\beta$ en référence à la diversité \og primaire \fg{} mesurable par l'indice $alpha$ de Fisher \autocite{Fisher1943} (voir le chapitre \ref{chap:Fisher}, page \pageref{chap:Fisher}).
