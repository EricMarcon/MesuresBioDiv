...
{\includegraphics[width=\maxwidth]{Conclusion}}
...
Les principales différences avec celui présenté ici concernent la définition de la diversité $\alpha$ et donc celle de la diversité $\beta$ et l'absence d'estimateurs à biais réduit.
