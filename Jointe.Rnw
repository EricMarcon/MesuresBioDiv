...
= \xq{D}{q}{}{\alpha}{} \xq{D}{q}{}{\beta}{} \xq{R}{q}{}{c}{}.
\end{equation}

La méta-communauté suivante illustre cette décomposition: elle contient $R=3$ répliques identiques de $D_{\beta}=2$ communautés équiprobables totalement distinctes, comprenant chacune $D_{\alpha}=2$ espèces équiprobables (Figure~\ref{DifferentiationFig}). 
