...
\newenvironment{Essentiel}
  {\begin{bclogo}[logo=\bctrombone, noborder=true, couleur=lightgray!50]{L'essentiel}}
  {\end{bclogo}}
...
InstallPackages(c("ade4", "adespatial", "entropart", "entropy", "EntropyEstimation", "gplots", "knitr", "sp", "SPECIES", "untb", "vegan"))
