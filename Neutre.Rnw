...
<<Neutre-parent, echo=FALSE, cache=FALSE>>=
...
\sisetup{locale = FR}
\chapter[Mesures neutres de la diversité alpha ou gamma]{Mesures neutres de la diversité $\alpha$ ou $\gamma$}
\label{chap:MesuresNeutres}
...
\lettrine{L}{es mesures} classiques \autocite{Peet1974} considèrent que chaque classe d'objets est différente de toutes les autres, sans que certaines soient plus ou moins semblables. 
Dans ce chapitre, les classes seront des espèces. 
Les mesures sont qualifiées de neutres (\foreignlanguage{english}{\emph{species-neutral}}) au sens où elles ne prennent en compte aucune caractéristique propre des espèces.
...
\section{Richesse spécifique}
\label{sec:Richesse}

La richesse est tout simplement le nombre d'espèces présentes dans le taxocène considéré.
C'est la mesure conceptuellement la plus simple mais pratiquement la plus délicate dans des systèmes très riches comme les forêts tropicales : même avec des efforts d'inventaire considérables, 
...
\subsection{Techniques d'estimation non paramétrique}

Dans le cadre d'un échantillonnage de $n$ individus, on observe $\xq{s}{}{n}{\ne 0}{}$ espèces différentes parmi les $S$ existantes. 
...
La probabilité de ne pas observer l'espèce est $1-(1-p_s)^n$.
...
\subsubsection{Chao1 et Chao2}

\textcite{Chao1984} estime le nombre d'espèces non observées à partir de celles observées 1 ou 2 fois.

Dans un échantillon de taille $n$ résultant d'un tirage indépendant des individus, la probabilité que l'espèce $s$ soit observée $\nu$ fois suit une loi binomiale.
L'espérance du nombre d'espèces observées $\nu$ fois, ${\mathbb E}(\xq{s}{}{n}{\nu}{})$, est obtenue en écrivant la probabilité d'observer l'espèce $s$ $\nu$ fois, sommée pour toutes les espèces et multipliée par le nombre de façons de choisir les $\nu$ individus parmi les $n$ échantillonnés:
\begin{equation}
\label{eq:Esnnu}
  {\mathbb E}\left( \xq{s}{}{n}{\nu}{} \right) = \binom{n}{\nu} \sum_s{p_s^\nu \left( 1-p_s \right)^{n-\nu}}.
\end{equation}

Le carré de la norme du vecteur en $S$ dimensions dont les coordonnées sont $(1-p_s)^{n/2}$ est 
$$\sum_s{(1-p_s)^n},$$
c'est-à-dire ${\mathbb E}(\xq{s}{}{n}{0}{})$, l'espérance du nombre d'espèces non observées.
Celui du vecteur de coordonnées $p_s (1-p_s)^{n/2-1}$ est 
$$\sum_s{p_s^2(1-p_s)^{n-2}}=\frac{2}{n(n-1)}{\mathbb E}(\xq{s}{}{n}{2}{}).$$
Enfin, le produit scalaire des deux vecteurs vaut 
$$\sum_s{p_s(1-p_s)^{n-1}}=\frac{1}{n}{\mathbb E}(\xq{s}{}{n}{1}{}).$$
  

L'inégalité de Cauchy-Schwartz (le produit scalaire est inférieur au produit des normes des vecteurs) peut être appliquée aux deux vecteurs (tous les termes sont au carré):
\begin{equation} 
...
\begin{equation} 
 {\mathbb E}(\xq{s}{}{n}{0}{}) 
  \ge \frac{n-1}{n}\frac{\left[ {\mathbb E}(\xq{s}{}{n}{1}{}) \right]^2}{2 {\mathbb E}(\xq{s}{}{n}{2}{})}.
\end{equation}
...
\begin{equation}
  ...
  {\hat{S}}_\mathit{Chao1} 
   = \xq{s}{}{n}{\ne 0}{} + \frac{\left(n-1 \right){\left(\xq{s}{}{n}{1}{}\right)}^2}{2n{\xq[\,]{s}{}{n}{2}{}}},
\end{equation}
...
\begin{equation}
  ...
  {\hat{S}}_\mathit{Chao1} = \xq{s}{}{n}{\ne 0}{} + \frac{\left(n-1\right){\xq{s}{}{n}{1}{}}\left(\xq{s}{}{n}{1}{}-1\right)}{2n}.
\end{equation}
...
\begin{equation}
  \hat{S}_\mathit{Chao1}
   = {\xq{s}{}{n}{\ne 0}{}} + \frac{{\left(\xq{s}{}{n}{1}{}\right)}^2}{2\xq[\,]{s}{}{n}{2}{}}.
\end{equation}

Si aucune espèce n'est observée deux fois, l'estimateur est remplacé \autocite{Chao2004} par $${\hat{S}}_\mathit{Chao1} = {\xq{s}{}{n}{\ne 0}{}}+{\xq{s}{}{n}{1}{}\left(\xq{s}{}{n}{1}{}-1\right)}/{2}.$$

La variance de l'estimateur est connue, mais pas sa distribution:

\begin{equation}
  \Var{\left({\hat{S}}_\mathit{Chao1}\right)} 
   = {\xq{s}{}{n}{2}{}}\left[\frac{1}{2}{\left(\frac{\xq{s}{}{n}{1}{}}{\xq{s}{}{n}{2}{}}\right)}^2 + {\left(\frac{\xq{s}{}{n}{1}{}}{\xq{s}{}{n}{2}{}}\right)}^3 + \frac{1}{4}{\left(\frac{\xq{s}{}{n}{1}{}}{\xq{s}{}{n}{2}{}}\right)}^4\right].
\end{equation}
...
\begin{equation}
  \Var{\left({\hat{S}}_\mathit{Chao1}\right)}
  = \frac{\xq{s}{}{n}{1}{}\left(\xq{s}{}{n}{1}{}-1\right)}{2}
  + \frac{\xq{s}{}{n}{1}{}{\left(2\xq[\,]{s}{}{n}{1}{} -1\right)}^2}{4}
  + \frac{{\left(\xq{s}{}{n}{1}{}\right)}^4}{4\xq[\,]{s}{}{n}{\ne 0}{}}.
\end{equation}

\textcite{Chao1987} calcule une approximation de l'intervalle de confiance à 95\%: 

\begin{equation}
  \xq{s}{}{n}{\ne 0}{}+\frac{{\hat{S}}_\mathit{Chao1}-{\xq{s}{}{n}{\ne 0}{}}}{c}\le S\le {\xq{s}{}{n}{\ne 0}{}}+\left({\hat{S}}_\mathit{Chao1}-{\xq{s}{}{n}{\ne 0}{}}\right)c,
\end{equation}

où

\begin{equation}
  c=e^{t^{n}_{1-{\alpha}/{2}}\sqrt{\ln\left(1+\frac{\Var\left({\hat{S}}_\mathit{Chao1}\right)}{{\left({\hat{S}}_\mathit{Chao1}-{\xq{s}{}{n}{\ne 0}{}}\right)}^2}\right)}}.
\end{equation}

\textcite{Eren2012}{}{ (eq.~8)} calculent un intervalle de confiance qui est plus petit quand la valeur maximum théorique du nombre d'espèces est connue, ce qui est rarement le cas en écologie.
...
\textcite{Chiu2014a} améliorent l'estimateur en reprenant la démarche originale de Chao mais en utilisant un estimateur plus précis du taux de couverture, (\ref{eq:CChao}) au lieu de (\ref{eq:CGood}):

\begin{equation}
  {\hat{S}}_\mathit{iChao1} 
  = {\hat{S}}_\mathit{Chao1} 
  + \frac{\xq{s}{}{n}{3}{}}{4\xq[\,]{s}{}{n}{4}{}}\,
  \max\left(\xq{s}{}{n}{1}{}-\frac{\xq{s}{}{n}{2}{}\xq[\,]{s}{}{n}{3}{}}{2\xq[\,]{s}{}{n}{4}{}};0\right).
\end{equation}
...
Une relation entre le nombre de doubletons et les données disponibles est fourni; sa résolution numérique (le code R nécessaire est fourni avec l'article) permet d'estimer $\xq{s}{}{n}{2}{}$ et de l'injecter dans l'estimateur Chao2.



\subsubsection{L'estimateur ACE}
...
\begin{equation}
  \hat{S}_{\mathit{ACE}} = \xq{s}{}{n}{>\kappa}{} + \frac{\xq{s}{}{n}{\le\kappa}{}}{\hat{C}_\mathit{rares}}+\frac{\xq{s}{}{n}{1}{}}{{\hat{C}}_\mathit{rares}}{\hat{\gamma}}_\mathit{rares}.
\end{equation}

$\xq{s}{}{n}{>\kappa}{}$ est le nombre d'espèces dites abondantes, observées plus de $\kappa$ fois, $\xq{s}{}{n}{\le\kappa}{}$ le nombre d'espèces dites rares, observées $\kappa$ fois ou moins. 
...
\begin{equation}
  \hat{\gamma}^{2}_\mathit{rares} = \max\left(\frac{\xq{s}{}{n}{\le\kappa}{}\sum^{\kappa}_{\nu=1}{\nu\left(\nu-1\right){\xq{s}{}{n}{\nu}{}}}}{\hat{C}_\mathit{rares}\left(\sum^{\kappa}_{\nu=1}{\nu\xq[\,]{s}{}{n}{\nu}{}}\right)\left(\sum^{\kappa}_{\nu=1}{\nu\xq[\,]{s}{}{n}{\nu}{}}-1\right)}-1; 0\right).
\end{equation}
...
\subsubsection{L'estimateur jackknife}
...
Burnham et Overton \autocite{Burnham1978, Burnham1979} ont utilisé cette technique pour obtenir des estimateurs du nombre d'espèces, appelés jackknife à l'ordre $j$, prenant en compte les valeurs de $\xq{s}{}{n}{1}{}$ à $\xq{s}{}{n}{j}{}$. 
Les estimateurs du premier et du deuxième ordre sont les plus utilisés en pratique:

\begin{equation} 
  \hat{S}_\mathit{J1} = {\xq{s}{}{n}{\ne 0}{}} + \frac{\left(n-1\right){\xq{s}{}{n}{1}{}}}{n},
\label{eq:Jack1}
\end{equation}

\begin{equation} 
  \hat{S}_\mathit{J2} = {\xq{s}{}{n}{\ne 0}{}} + \frac{\left(2n-3\right){\xq{s}{}{n}{1}{}}}{n} - \frac{{\left(n-2\right)}^{2}\xq[\,]{s}{}{n}{2}{}}{n\left(n-1\right)}.
\end{equation}
...
\begin{equation} 
  \Var{\left( \hat{S}_\mathit{J1} \right)}
  = \frac{n-1}{n} \left( \sum_{j=1}^{n}{j^2 \xq{s}{}{n}{j}{}} - \frac{\left( \xq{s}{}{n}{\ne 0}{} \right)^2}{n} \right).
\end{equation}

L'estimateur est construit à partir de l'hypothèse selon laquelle le nombre d'espèces non observées est de la forme
$$\xq{s}{}{n}{0}{} = \sum_{i=1}^{\infty}{\frac{a_i}{n^i}}.$$

Pour cette raison, \textcite{Cormack1989} affirme qu'il n'a pas de support théorique solide.
L'espérance du nombre d'espèces non observées est (équation~\ref{eq:Esnnu}) $\sum_s{(1-p_s)^n}$, qui décroît beaucoup plus rapidement que $\sum_{i}{\nicefrac{a_i}{n^i}}$: l'hypothèse est bien fausse.
...
L'échantillon est présenté en Figure~\ref{BiaisJack1Fig}
\verbfootnote{
Code R:
<<BiaisJack1Code, eval=FALSE>>=
plot(Ns, Distribution="lnorm")
@
}.

\figureMargin{BiaisJack1Fig}
{
  Echantillon de 1000 individus tiré dans une communauté log-normale.
}
{
<<BiaisJack1Fig, echo=FALSE, results='hide', out.width='\\maxwidth'>>=
<<BiaisJack1Code>>
@
}
...
Le nombre d'espèces non observées, qui est le biais de l'estimateur de la richesse, est présenté en Figure~\ref{BiaisJack3Fig}
\verbfootnote{
Code R:
<<BiaisJack3Code, eval=FALSE>>=
plot(x=n.seq , y=Bias, type="l")
lines(x=n.seq, y=predict(lm1), col="red", lty=2)
lines(x=n.seq, y=predict(lm2), col="orange", lty=2)
lines(x=n.seq, y=predict(lm4), col="blue", lty=2)
@
}.
...
<<BiaisJack4>>=
# Ordre 1
summary(lm1 <- lm(Bias ~ 0 +I(1/n.seq)))
# Ordre 2
summary(lm2 <- lm(Bias ~ 0 +I(1/n.seq) + I(1/n.seq^2)))
# Ordre 4
summary(lm4 <- lm(Bias ~ 0 +I(1/n.seq) + I(1/n.seq^2) + I(1/n.seq^3) + I(1/n.seq^4)))
@

\figureSC[t]{BiaisJack3Fig}
{
  Nombre d'espèces non obervées dans un échantillon de taille croissante et sa décomposition en séries de puissances négatives de $n$.
  Le nombre d'espèces non observées est représenté par la courbe continue noire.
  Les séries de puissances négatives d'ordre 1 (courbe rouge), 2 (courbe orange) et 4 (courbe bleue) sont représentées en pointillés.
  Les courbes d'ordre 6 et plus sont confondues avec la courbe noire. 
}
{
<<PhylogFig, echo=FALSE, results='hide', out.width='\\textwidth'>>=
<<BiaisJack3Code>>
@
}
...
\`A condition que $n$ soit suffisamment grand, l'estimateur du nombre d'espèces non observées est une fonction linéaire du nombre d'espèces observées $\nu$ fois: $\xq{s}{}{n}{1}{}$ pour le jackknife 1, $2 \xq{s}{}{n}{1}{} - \xq{s}{}{n}{2}{}$ pour le jackknife 2 et ainsi de suite pour les ordres suivants, contrairement à l'estimateur de Chao.
...
\subsubsection{L'estimateur du bootstrap}

L'estimateur du bootstrap \autocite{Smith1984} est
\begin{equation} 
  \hat{S}_\mathit{b} = {\xq{s}{}{n}{\ne 0}{}} + \sum_s{(1-p_s)^n}.
\end{equation}
...
Les estimateurs et leurs intervalles de confiance peuvent également être calculés avec le package \emph{vegan} qui dispose pour cela de deux fonctions: \code{specpool} et \code{estimateR}. 

\code{specpool} est basé sur les incidences des espèces dans un ensemble de sites d'observation et donne une estimation unique de la richesse selon les méthodes Chao2, jackknife (ordre 1 et 2) et bootstrap. 
L'écart-type de l'estimateur est également fourni par la fonction, sauf pour le jackknife d'ordre 2.

\code{estimateR} est basé sur les abondances des espèces et retourne un estimateur de la richesse spécifique par site et non global comme \code{specpool}.

\subsubsection{Exemple}

On utilise les données de Barro Colorado Island (BCI). 
La parcelle a été divisée en carrés de \SI{1}{\hectare}. 
Le tableau d'entrée est un \code{dataframe} contenant, pour chaque espèce d'arbres ($\mathit{DBH}\ge$\SI{10}{\centi\meter}), ses effectifs par carré.
...
On utilise la fonction \code{estimateR} pour calculer la richesse des deux premiers carrés:
...
Comparaison des fonctions sur l'ensemble du dispositif BCI ($\xq{s}{}{n}{\ne 0}{}=225$, $\xq{s}{}{}{1}{}=19$):
...
La valeur du jackknife 1 fournie par \code{specpool} est fausse. 
La fonction \code{jackknife} de \emph{SPECIES} donne le bon résultat, avec un intervalle de confiance calculé en supposant que la distribution est normale ($\pm$1,96 écart-type au seuil de 95\%).
...
\subsubsection{Choix de l'estimateur}
\label{sec:ChoixEstimateur}

Des tests poussés ont été menés par \textcite{Brose2003} pour permettre le choix du meilleur estimateur de la richesse en fonction de la complétude de l'échantillonnage $\xq{s}{}{n}{\ne 0}{}/{S}$. 
Les auteurs appellent cette proportion couverture (\foreignlanguage{english}{\emph{coverage}}). 
Le terme \foreignlanguage{english}{\emph{completeness}} a été proposé par \textcite{Beck2010} pour éviter la confusion avec le taux de couverture défini par Good (vu page~\pageref{sec:Couverture}). 
...
\figureSC{Brose2003}
  {Arbre de décision du meilleur estimateur du nombre d'espèces, \emph{in} \textcite{Brose2003}.}
  {\includegraphics[width=\maxwidth]{Brose2003}}

Dans tous les cas, les estimateurs jackknife sont les meilleurs. 
L'arbre de décision est en Figure~\ref{Brose2003}. 
Le choix dépend principalement de la complétude (\foreignlanguage{english}{\emph{coverage}} sur la figure). 
...
S'ils sont incohérents (intervalle des estimations supérieur à 50\% de leur moyenne), le critère majeur est l'équitabilité (voir page~\pageref{sec:Equitabilite}). 
...
Exemple de BCI: le nombre d'espèces estimé par jackknife 1 est 244. 
...
Enfin, \textcite{Beguinot2015a, Beguinot2016} suggère d'utiliser en règle générale le jacknife 2 (mais ne traite pas les cas dans lesquels l'échantillonnage est trop faible pour justifier un ordre supérieur) tant que  le nombre de singletons est supérieur à $2-\sqrt(2) \approx 0,6$ fois le nombre de doubletons.
Le ratio des singletons sur les doubletons diminue quand l'échantillonnage approche de l'exhaustivité.
Quand le seuil de 0,6 est dépassé, la valeur de l'estimateur de Chao devient supérieur au jancknife 2 et doit être utilisé.
Ce seuil est cohérent avec les règles de \textcite{Brose2003}.


\subsubsection{Prédiction de la richesse d'un nouvel échantillon}
\label{sec:Shen2003}
...
On note $\xq{\hat{S}}{}{n}{0}{}$ l'estimateur du nombre d'espèces non observées dans le premier échantillon, et $\hat{C}$ l'estimateur de son taux de couverture. 
L'estimateur du nombre d'espèces du nouvel échantillon de $n'$ individus est

\begin{equation}
  \hat{S'} = \xq{\hat{S}}{}{n}{0}{} \left[1-{\left(1-\frac{1-\hat{C}}{\xq{\hat{S}}{}{n}{0}{}}\right)}^{n'}\right].
\end{equation}

$\xq{\hat{S}}{}{n}{0}{}$ est obtenu par la différence entre les nombres d'espèces estimé et observé: $\xq{\hat{S}}{}{n}{0}{}=\hat{S}-\xq{s}{}{n}{\ne 0}{}$.

Exemple de BCI, suite du code de la page~\pageref{code:VerifJack1} : combien de nouvelles espèces seront découvertes en échantillonnant plus?
...
\figureSC{NonObserve}
  {Nombres de nouvelles espèces découvertes en fonction de l'effort d'échantillonnage supplémentaire (données de BCI). 
Seulement 7 nouvelles espèces seront observées en échantillonnant 10000 arbres supplémentaires (environ \SI{25}{\hectare} en plus des \SI{50}{\hectare} de la parcelle qui contiennent 225 espèces).
  }
  {
  <<NonObsNFig, echo=FALSE, results='hide'>>=
  <<NonObsN>>
  @
  }
...
La courbe obtenue est en Figure~\ref{NonObserve}
...
\subsection{Inférence du nombre d'espèces à partir de la SAD}

\subsubsection{Distribution de Preston}
...
L'ajustement direct du modèle aux données, sans regroupement par octaves \autocite{Williamson2005}, est également possible (Figure~\ref{PrestonSansOFig}
\verbfootnote{Le code R nécessaire pour réaliser la figure est:
  <<PrestonSansO2, eval=FALSE>>=
  plot(mod.ll)
  @
}):
...
\figureMargin{PrestonSansOFig}
  {Ajustement du modèle de Preston aux données de BCI.
  }
  {
  <<PrestonSansOFig, echo=FALSE, results='hide', out.width='\\textwidth'>>=
  <<PrestonSansO2>>
  @
  }


\subsubsection{Maximum de vraisemblance d'une distribution de Fisher}

\textcite{Norris1998} supposent que la distribution des espèces suit le modèle de Fisher (voir page~\pageref{eq:AlphaFisher}) et infèrent le nombre d'espèces par maximum de vraisemblance non paramétrique (ils ne cherchent pas à inférer les paramètres de la loi de probabilité de $p_s$ mais seulement à ajuster au mieux le modèle de Poisson aux valeurs de ${\hat{p}}_s$ observées).

Le calcul est possible avec la librairie \emph{SPECIES} de R:

<<NorrisPollock, eval=FALSE>>=
# Distribution du nombre d'espèces (vecteur: 
# noms = nombre d'individus
# valeurs = nombres d'espèces ayant ce nombre d'individus)
Ns <- colSums(BCI)
...
% Les fonctions de la librairie SPECIES bloquent knitr
<<Wang, eval=FALSE>>=
...
Il est disponible dans \emph{SPECIES} : fonction \code{pcg}. 
...
\subsection{Inférence du nombre d'espèces à partir de courbes d'accumulation}
\label{sec:RichesseSAC}
...
La courbe d'accumulation de BCI a été calculée page~\pageref{SACFig}.
...
Le nombre d'espèces estimé est \Sexpr{round(Shat, 0)}, inférieur au nombre d'espèces observé.
...
\begin{equation} 
  \left[\frac{1}{\xq{\hat{S}}{}{n}{}{}}\right] = \frac{K}{\hat{S}}\left[\frac{1}{n}\right]+\frac{1}{\hat{S}} 
\end{equation}
...
\figureSC{LineweaverFig}
  {Ajustement du même modèle de Michaelis-Menten transformé selon Lineweaver et Burk.
  }
  {
  <<LineweaverFig, echo=FALSE, results='hide'>>=
  <<Lineweaver2>>
  @
  }


On voit assez clairement que le modèle (Figure~\ref{LineweaverFig}
\verbfootnote{Le code R nécessaire pour réaliser la figure est:
  <<Lineweaver2, eval=FALSE>>=
  plot(y ~ x)
  abline(lm1$coef)
  @
}) s'ajuste mal quand il est représenté sous cette forme \autocite{Raaijmakers1987}.
...
\begin{equation} 
  \xq{S}{}{n}{}{} = \frac{1}{z} \ln \left[ \frac{a}{c} - \frac{a-c}{c} e^{-czn} \right].
\end{equation}
...
\figureSC{SobLLorFig}
  {Ajustement des modèle de Michaelis-Menten (trait plein) et de de Soberón et Llorente (pointillés longs : modèle exponentiel négatif; pointillés courts : modèle à trois paramètres) aux données de BCI. 
Les cercles représentent le nombre d'espèces cumulées en fonction du nombre d'arbres.
Le modèle exponentiel négatif (Holdridge) sous-estime la richesse, plus que celui de Michaelis-Menten (Clench). Le modèle à trois paramètres s'ajuste mieux aux données, mais il surestime probablement la richesse.
  }
  {
  <<SobLLorFig, echo=FALSE, results='hide'>>=
  <<SobLLor>>
  @
  }

L'estimation est cette fois supérieure à celle du jackknife (\Sexpr{round(SPECIES::jackknife(AbdFreqCount(Ns))$Nhat, 0)} espèces).

La figure~\ref{SobLLorFig}
\verbfootnote{Le code R nécessaire pour réaliser la figure est:
  <<SobLLor, eval=FALSE>>=
  plot(nArbres, nEspeces)
  # Courbe ajustée
  x <- seq(from=0, to=max(nArbres), length=255)
  lines(x = x, y = predict(nlsfit, newdata = list(nArbres = x)))
  lines(x = x, y = predict(nlsexp, newdata = list(nArbres = x)), lty=2)
  lines(x = x, y = predict(nlslog, newdata = list(nArbres = x)), lty=3)
  @
} présente les deux ajustements de modèle de Soberón et Llorente avec celui de Clench. 
...
\subsection{Diversité générique}
...
\subsection{Combien y a-t-il d'espèces différentes sur Terre?}
...
Cette méthode est applicable jusqu'au niveau du genre (Figure~\ref{Mora2011}, A à E). 
Le nombre de taxon de chaque niveau est lié à celui du niveau précédent, ce qui est représenté par la Figure~\ref{Mora2011}, G sous la forme du relation linéaire entre le logarithme du logarithme du nombre de taxons et le rang (1 pour les phylums, 5 pour les genres). 
...
\figureFW{Mora2011}
  {\'Evolution du nombre de taxons connus en fonction du temps et valeur estimée du nombre total (ligne horizontale grise, A à E). 
Le nombre d'espèces connues est trop faible pour utiliser cette méthode (F). 
Il est obtenu par extrapolation de la relation du nombre de taxons d'un niveau à celui du niveau supérieur (G). 
\emph{In} \cite[][fig.~1]{Mora2011} , Animalia seulement.
  }
  {\includegraphics[width=\maxwidth]{Mora2011}}


En se limitant aux arbres, l'estimation se monte à \SI{16000} espèces pour l'Amazonie \autocite{TerSteege2013}, de l'ordre de 5000 pour l'Afrique et entre 40000 et 53000 pour l'ensemble des tropiques \autocite{Slik2015} (donc pour l'ensemble de la planète, le nombre d'espèces non-tropicales étant négligeable).
Ces estimations sont obtenues par extrapolation du modèle en log-séries (capitre~\ref{chap:Fisher}) et sont sujettes au paradoxe de Fisher: les espèces représentées par un très petit nombre d'individu dans le modèle, notamment les singletons, sont les plus nombreuses.
...
\textcite{Hurlbert1971} l'a divisé par sa valeur maximale $1-{1}/{S}$ pour obtenir une mesure d'équitabilité valide généralisée plus tard par \textcite{Mendes2008} (voir page~\pageref{sec:Mendes}).
...
Le calcul de l'indice de Simpson peut se faire avec la fonction \code{diversity} disponible dans le package \emph{vegan} de R ou avec la fonction \code{Simpson} du package \emph{entropart} :
...
\begin{equation} 
  \tilde{E} = \left(\frac{n}{n-1}\right)\left(1-\sum^{\xq{s}{}{n}{\ne 0}{}}_{s=1}{{\hat{p}}^2_s}\right).
\end{equation}
...
La fonction \code{Simpson} de \emph{entropart} accepte comme argument un vecteur d'abondances et propose par défaut la correction de Lande:
...
\section{Indice de Shannon}

\subsection{Définition}

L'indice de Shannon \autocite{Shannon1948, Shannon1963}, aussi appelé indice de Shannon-Weaver ou Shannon-Wiener, ou simplement \emph{entropie} est dérivé de la théorie de l'information:
...
On ne s'intéresse pas aux listes de plantes ne respectant pas les probabilités individuelles.

$H=(\ln{L})/{n}$ est l'indice de Shannon. 
Ce résultat est connu sous le nom de formule de \textcite{Brillouin1962}. 
\`A l'origine, Shannon a utilisé un logarithme de base 2 pour que $H$ soit le nombre moyen de questions binaires (réponse oui ou non) nécessaire pour identifier l'espèce d'une plante (un caractère utilisé dans une chaîne dans le contexte du travail de Shannon). 
Les logarithmes naturels, de base 2 ou 10 ont été utilisés par la suite \autocite{Pielou1966a}.

La formule (\ref{eq:ShannonlnL}) est celle de l'indice de \textcite{Theil1967}, présenté en détail par \textcite{Conceicao2000}, à l'origine utilisé pour mesurer les inégalités de revenu puis pour caractériser les structures spatiales en économie. 
...
Le calcul de l'indice de Shannon peut se faire avec la fonction \code{diversity} disponible dans le package \emph{vegan} de R ou avec la fonction \code{Shannon} de \emph{entropart} :
...
$\mathrm{\Psi}(\cdot)$ est la fonction digamma, et $\hat{\alpha}$ est l'estimateur de l'indice de Fisher (voir page~\pageref{eq:AlphaFisher}):
...
\begin{equation}
\tilde{H} = -\sum^{\xq{s}{}{n}{\ne 0}{}}_{s=1}{\hat{p}_s \ln{\hat{p}_s}} + \frac{\xq{s}{}{n}{\ne 0}{}-1}{2n}.
...
\textcite{Beck2010} montrent que la correction du biais est efficace, même à des niveaux de complétude de l'échantillonnage (voir page~\pageref{Brose2003}) très faibles. \textcite{Vu2007} étudient la vitesse de convergence de l'estimateur. 
...
\begin{equation}
H_z = \sum^{n-1}_{v=1}{\frac{1}{v}\left\{\frac{n^{v+1}\left[n-\left(v+1\right)\right]!}{n!}\sum^{\xq{s}{}{n}{\ne 0}{}}_{s=1}{p_s\prod^{v-1}_{j=0}{\left(1-{\hat{p}}_s-\frac{j}{n}\right)}}\right\}}.
\end{equation}
...
\`A partir de ce seuil, l'augmentation de $\ln{L}$ par individu ajouté est calculée pour chaque relevé supplémentaire. 
...
\begin{multline}
  ...
  -\frac{\xq{s}{}{}{1}{}}{n} {\left(1-A\right)}^{1-n} \left(-{\ln\left( A \right)}-\sum^{n-1}_{r=1}{\frac{1}{r}{\left( 1-A \right)}^r}\right),
\label{eq:Chao2013}
\end{multline}
...
\begin{itemize}
  \item  $2\xq[\,]{s}{}{}{2}{}/{\left[\left(n-1\right) \xq{s}{}{}{1}{} +2\xq[\,]{s}{}{}{2}{}\right]}$ en présence de singletons et doubletons;
  \item  $2/{\left[\left(n-1\right)\left(\xq{s}{}{}{1}{} -1\right)+2\right]}$ en présence de singletons seulement;
  \item  $1$ en absence de singletons et doubletons.
\end{itemize}
...
\`A cause de la concavité, $\ln({\hat{p}}_s)$ est en moyenne inférieur à $\ln(p_s)$: cette relation est connue sous le nom d'inégalité de \textcite{Jensen1906}. 
L'indice de Shannon est concave (Figure~\ref{ShannonFig}
\verbfootnote{Le code R nécessaire pour réaliser la figure est:
  <<ShannonCode, eval=FALSE>>=
  curve(-x*log(x), 0.0001, 1)
  @
}) donc son estimateur (\ref{eq:Shannon}) est biaisé négativement, même sans prendre en considération les espèces non observées.

\figureMargin{ShannonFig}
  {courbe de $-x\ln x$ entre 0 et 1.).}
  {
  <<ShannonFig, echo=FALSE, results='hide', out.width='\\textwidth'>>=
  <<ShannonCode>>
  @
  }
...
La valeur du biais en fonction de $p_s$ est en Figure~\ref{ShannonBiaisFig}
\verbfootnote{
Code R:
<<ShannonBiaisCode, eval=FALSE>>=
  Biais.p <- function (p) {
...
\figureMargin{ShannonBiaisFig}
  {Biais de $-\hat{p}_s \ln\hat{p}_s$ entre 0 et 1.
  }
  {
  <<ShannonBiaisFig, echo=FALSE, results='hide', out.width='\\textwidth'>>=
  <<ShannonBiaisCode>>
  @
  }
...
La fonction \code{Shannon} permet toutes ces corrections. 
...
L'estimateur $\nicefrac{1}{S}$, si $S$ est connu, est de variance nulle mais est très biaisé. 
...
L'estimateur de James-Stein (\foreignlanguage{english}{\emph{shrinkage estimator}}) optimal est
\begin{eqnarray}
  \tilde{p}_s = \hat{\lambda}\frac{1}{\hat{S}} + \left( 1-\hat{\lambda} \right)\hat{p}_s, \\
  \hat{\lambda} = \frac{1-\sum^{\xq{s}{}{n}{\ne 0}{}}_{s=1}{\left( \hat{p}_s \right)^2}}
                  {\left( n-1 \right) \sum^{\xq{s}{}{n}{\ne 0}{}}_{s=1}{\left( \frac{1}{\hat{S}} - \hat{p}_s \right)^2}}.
\end{eqnarray}

L'entropie est ensuite simplement estimée par l'estimateur plug-in : $\tilde{H} = -\sum^{\xq{s}{}{n}{\ne 0}{}}_{s=1}{\tilde{p}_s \ln{\tilde{p}_s}}$. 
...
Les fréquences sont estimées par la fonction \code{freqs.shrink}. 
...
\begin{equation}
  \xq{S}{}{}{}{k} = \sum^S_{s=1}{\left[1-{\left(1-p_s\right)}^k\right]}.
\end{equation}
...
L'indice peut être converti en nombre équivalent d'espèces \autocite{Dauby2012} (c'est-à-dire le nombre d'espèces équiprobables nécessaire pour obtenir la même diversité) notés $\xq{D}{}{}{}{k}$ à partir de la relation

\begin{equation}
\label{eq:HurlbertD}
  \xq{S}{}{}{}{k} = \xq[\,]{D}{}{}{}{k} \left[1-{\left(1-\frac{1}{\xq{D}{}{}{}{k}}\right)}^k\right].
\end{equation}

L'équation doit être résolue pour obtenir $\xq{D}{}{}{}{k}$ à partir de la valeur de $\xq{S}{}{}{}{k}$ estimée, numériquement pour $k>3$.

Dans deux cas particuliers, les nombres équivalents d'espèces de Hurlbert sont identiques aux nombres de Hill: $\xq{D}{}{}{}{2} =\xq[\,]{D}{2}{}{}{}$ et $\xq{D}{}{}{}{\infty}=\xq[\,]{D}{0}{}{}{}$.

Pour les autres ordres entiers de diversité, il existe une correspondance parfaite entre les deux mesures \autocite[][Annexe S2]{Chao2014} : la connaissance de l'une suffit permet d'obtenir l'autre. Pour $k>1$, on a \autocite{Leinster2012}

\begin{equation}
  \xq{S}{}{}{}{k} = k + \sum_{q=2}^{k}{\binom{k}{q} (-1)^{q+1} (\xq{D}{q}{}{}{})^{1-q}}.
\end{equation}

On a vu que $\xq[\,]{D}{0}{}{}{}$ égale $\xq{D}{}{}{}{\infty}$, donc $\xq{S}{}{}{}{\infty}=\xq[\,]{D}{0}{}{}{}$ (équation~\ref{eq:HurlbertD}).

Inversement, pour $q>1$:

\begin{equation}
  (\xq{D}{q}{}{}{})^{1-q} = q + \sum_{k=2}^{q}{\binom{q}{k} (-1)^{k+1} \xq{S}{}{}{}{k}}.
\end{equation}

Pour $q=1$, la relation est \autocite{Mao2007}
\begin{equation}
  \xq{H}{1}{}{}{} = -1 + \sum_{k=2}^{\infty}{\frac{\xq{S}{}{}{}{k}}{k(k-1)}}.
\end{equation}
...
\begin{Essentiel}
  ...
  L'entropie va de pair avec la diversité au sens strict (Nombres de Hill): le nombre d'espèces équiprobables dont l'entropie est la même que celle de la communauté réelle. Les profils de diversité représentent la diversité en fonction de son ordre et permettent la comparaison de communautés.
...
\lettrine{L}{'entropie} peut être entendue comme la surprise moyenne fournie par l'observation d'un échantillon. 
...
La probabilité d'obtenir $r_s$ est $p_s$, et\break
$\vectorsym{p}=(p_1,p_2,\dots,p_S)$ est le vecteur composé des probabilités d'obtenir chaque résultat. 
...
\textcite{Patil1982} appellent l'information \og rareté\fg{}.

La quantité d'information attendue de l'expérience est\break
$\sum^S_{s=1}{p_s I(p_s) = H(\vectorsym{p})}$. 
Si on choisit $I\left(p_s\right)=-\ln\left(p_s\right)$, $H\left(\vectorsym{p}\right)$ est l'indice de Shannon, mais bien d'autres formes de $I\left(p_s\right)$ sont possibles. 
$H\left(\vectorsym{p}\right)$ est appelée \emph{entropie}. 
...
Si $\vectorsym{p}$ est la distribution des probabilité des espèces dans une communauté, \textcite{Patil1982} montrent que:
\begin{itemize}
  \item  Si $I\left(p_s\right) = \frac{1-p_s}{p_s}$, alors $H\left(\vectorsym{p}\right)$ est le nombre d'espèces $S$ moins 1;
  \item  Si $I\left(p_s\right)=-\ln\left(p_s\right)$, alors $H\left(\vectorsym{p}\right)$ est l'indice de Shannon;
  \item  Si $I\left(p_s\right)=1-p_s$, alors $H\left(\vectorsym{p}\right)$ est l'indice de Simpson.
\end{itemize}

\figureSC{IFig}
  {Fonctions d'information utilisées dans le nombre d'espèces (trait plein), l'indice de Shannon (pointillés longs) et l'indice de Simpson (pointillés). 
L'information apportée par l'observation d'espèces rares décroît du nombre d'espèces à l'indice de Simpson.}
  {
<<IFig, echo=FALSE, results='hide'>>=
<<ICode>>
@
  }

Ces trois fonctions d'information sont représentées en Figure~\ref{IFig}
\verbfootnote{
Le code R nécessaire pour réaliser la figure est:
<<ICode, eval=FALSE>>=
curve((1-x)/x, 0, 1, lty=1, xlab="p", ylab="I(p)", ylim=c(0,10))
curve(-log(x), 0, 1, lty=2, add=TRUE)
curve(1-x, 0, 1, lty=3, add=TRUE)
@
}.

\figureSC{EntropieFig}
  {Valeur de $p_{s}I\left(p_s\right)$ dans le nombre d'espèces (trait plein), l'indice de Shannon (pointillés longs) et l'indice de Simpson (pointillés). 
Les espèces rares contribuent peu, sauf pour le nombre d'espèces}
  {
<<EntropieFig, echo=FALSE, results='hide'>>=
<<EntropieCode>>
@
  }

La contribution de chaque espèce à la valeur totale de l'entropie est représentée Figure~\ref{EntropieFig}
\verbfootnote{
Code R:
<<EntropieCode, eval=FALSE>>=
curve(1-x, 0, 1, lty=1, xlab="p", ylab="p I(p)")
curve(-x*log(x), 0, 1, lty=2, add=TRUE)
curve(x*(1-x), 0, 1, lty=3, add=TRUE)
@
}.

\section{Entropie relative}

Considérons maintenant les probabilités $q_s$ formant l'ensemble $\vectorsym{q}$ obtenues par la réalisation de l'expérience. 
...
La quantité totale d'information fournie par l'expérience, $\sum^S_{s=1}{q_sI(q_s,p_s)}=H(\vectorsym{q},\vectorsym{p})$, est souvent appelée entropie relative. 
Elle peut être vue comme une distance entre la distribution \emph{a priori} et la distribution \emph{a posteriori}. 
Il est possible que les distributions $\vectorsym{p}$ et $\vectorsym{q}$ soit identiques, que le gain d'information soit donc nul, mais les estimateurs empiriques n'étant pas exactement égaux entre eux, des tests de significativité de la valeur de $\hat{H}(\vectorsym{q},\vectorsym{p})$ seront nécessaires.

Quelques formes possibles de $H(\vectorsym{q},\vectorsym{p})$ sont:

\begin{itemize}
\item  La divergence de Kullback-Leibler \autocite{Kullback1951} connue par les économistes comme l'indice de dissimilarité de \textcite{Theil1967} :
\end{itemize}
...
\begin{itemize}
\item  Sa proche parente, appelée parfois deuxième mesure de Theil \autocite{Conceicao2000}, qui inverse simplement les rôles de $p$ et $q$:
\end{itemize}
...
\figureSC{KullbackLeiblerFig}
{Valeur de $q\ln(\nicefrac{q}{p})$ en fonction de $p$ et $q$. 
La divergence de Kullback-Leibler est la somme de cette valeur pour toutes les espèces}
{
<<KullbackLeiblerFig, echo=FALSE, message=FALSE, results='hide'>>=
<<KullbackLeiblerCode>>
@
}


L'entropie relative est essentielle pour la définition de la diversité $\beta$ présentée dans le chapitre~\ref{Decomposition}. 
...
Les valeurs de chaque terme de la divergence sont représentées Figure~\ref{KullbackLeiblerFig}
\verbfootnote{
Le code R nécessaire pour réaliser la figure est:
<<KullbackLeiblerCode, eval=FALSE, message=FALSE>>=
p <- q <- seq(0.01, 1, .01)
...
\section{L'appropriation de l'entropie par la biodiversité}
...
\begin{equation}
\xq{R}{q}{}{}{} =\frac{1}{1-q\ln\sum^S_{q=1}{p^q_s}}.
\end{equation}

Rényi pose également les axiomes pour une mesure d'entropie $R\left(\vectorsym{p}\right)$, où $\vectorsym{p}=(p_1,p_2,\dots,p_S)$:
\begin{itemize}
  \item  La symétrie: les espèces doivent être interchangeables, aucune n'a de rôle particulier et leur ordre est indifférent;
  \item  La mesure doit être continue par rapport aux probabilités;
  \item  La valeur maximale est atteinte si toutes les probabilités sont égales.
\end{itemize}

Il montre que $\xq{R}{q}{}{}{}$ respecte les 3 axiomes.

\textcite{Patil1982} ont montré de plus que:

\begin{itemize}
  \item  L'introduction d'une espèce dans une communauté augmente sa diversité (conséquence de la décroissance de $g(p_s)$);
  \item  Le remplacement d'un individu d'une espèce fréquente par un individu d'une espèce plus rare augmente l'entropie à condition que $R(\vectorsym{p})$ soit concave. 
...
\begin{equation}
\xq{D}{q}{}{}{} = {\left(\sum^S_{s=1}{p^q_s}\right)}^{\frac{1}{1-q}}.
\end{equation}

Le souci de Hill était de rendre les indices de diversité intelligibles après l'article remarqué de \textcite{Hurlbert1971} intitulé \og le non-concept de diversité spécifique\fg{}. 
...
\begin{itemize}
  \item  $\xq{D}{0}{}{}{}$ est le nombre d'espèces;
  \item  $\xq{D}{1}{}{}{}=e^H$, l'exponentielle de l'indice de Shannon;
  \item  $\xq{D}{2}{}{}{}={1}/{\left(1-E\right)}$, l'inverse de l'indice de concentration de Simpson, connu sous le nom d'indice de \textcite{Stoddart1983}.
\end{itemize}
...
Le concept a été défini rigoureusement par Gregorius\autocite{Gregorius1991}, d'après \textcite{Wright1931} (qui avait le premier défini la taille effective d'une population): étant donné une variable caractéristique (ici, l'entropie) fonction seulement d'une variable numérique (ici, le nombre d'espèces) dans un cas idéal (ici, l'équiprobabilité des espèces), le nombre effectif est la valeur de la variable numérique pour laquelle la variable caractéristique est celle du jeu de données. 
...
Cette dernière propriété sera traitée en détail dans la partie~\ref{part:Beta}. 
...
Parmi les possibilités, $I(p_s) = \cos{(p_s \nicefrac{\pi}{2})}$ est envisageable par exemple: le choix de la fonction d'information est virtuellement illimité, mais seules quelques unes seront interprétables clairement.
...
Par exemple, \textcite{Ricotta2003c} proposent d'utiliser la fonction d'information $I(p_s)=-\ln(k_s)$ où $k_s$ est la dissimilarité totale de l'espèce $s$ avec les autres (par exemple, la somme des distances aux autres espèces dans un arbre phylogénétique, voir page~\pageref{sec:Dphylo}), normalisée pour que $\sum_s{k_s}=1$.
...
\textcite{Ricotta2006b} ont défini plus tard une entropie augmentant avec l'originalité de chaque espèce, présentée au chapitre~\ref{sec:LeinsterCobbold}).



\section{Entropie HCDT}
...
\begin{equation}
  \xq{H}{q}{}{}{} = \frac{1}{q-1}\left(1-\sum^S_{s=1}{p^q_s}\right).
\label{eq:HCDT}
\end{equation}
...
Ces résultats ont été complétés par d'autres et repris en écologie par \textcite{Keylock2005} et \textcite{Jost2006, Jost2007}. 
Là encore:
\begin{itemize}
  \item  Le nombre d'espèces moins 1 est $\xq{H}{0}{}{}{}$;
  \item  L'indice de Shannon est $\xq{H}{1}{}{}{}$;
  \item  L'indice de Gini-Simpson est $\xq{H}{2}{}{}{}$.
\end{itemize}
...
\subsection{Logarithmes déformés}
...
Le logarithme déformé converge vers le logarithme naturel quand $q\to 1$ (Figure~\ref{lnqFig}
\verbfootnote{Le code R nécessaire pour réaliser la figure est:
<<lnqCode, eval=FALSE>>=
curve(log(x), 0, 1, lty=1, ylab = expression(ln[q](x)))
curve(lnq(x, 0), 0, 1, lty = 2, add = TRUE)
curve(lnq(x, 2), 0, 1, lty = 3, add = TRUE)
curve(lnq(x, -1), 0, 1, lty = 4, add = TRUE)  
legend("bottomright", legend = c(expression(ln[0](x)), "ln(x)",
      expression(ln[2](x)), expression(ln[-1](x))),
...
\figureSC{lnqFig}
{Valeur du logarithme d'ordre $q$ de probabilités entre 0 et 1 pour différentes valeurs de $q$: $q = 0$ (pointillés longs), la courbe est une droite; $q = 1$ (trait plein): logarithme naturel; $q = 2$ (pointillés courts): la courbe a la même forme que le logarithme naturel pour les valeurs positives de $q$; $q =-1$ (pointillés alternés): la courbe est convexe pour les valeurs négatives de $q$.}
{
<<lnqFig, echo=FALSE, results='hide'>>=
<<lnqCode>>
@
}
...
Si $q>1$, ${\mathop{\lim }_{x\to +\infty } \left(\ln_q{x}\right)={1}/{\left(q-1\right)}}$, donc $e^x_q$ n'est pas défini pour $x>{1}/{\left(q-1\right)}$.
...
Ces fonctions sont implémentées dans le package \emph{entropart} : \code{lnq(x, q)} et \code{expq(x, q)}.

L'entropie d'ordre $q$ s'écrit

\begin{equation}
  \xq{H}{q}{}{}{} = \frac{1}{q-1}\left(1-\sum^S_{s=1}{p^q_s}\right)=-\sum_s{p^q_s}\ln_q{p_s}=\sum_s{p_s}\ln_q\frac{1}{p_s}.
...
Le calcul de $\xq{H}{q}{}{}{}$ peut se faire avec la fonction \code{Tsallis} de la librairie \emph{entropart} :
...
En raison de leurs propriétés, notamment de décomposition (voir le chapitre~\ref{Decomposition}), \textcite{Jost2007} les appelle \og vraie diversité\fg{}. 
\textcite{Hoffmann2008} critiquent cette définition totalitaire\footnote{\textcite{Jost2009} reconnaît qu'un autre terme aurait pu être choisi (\og diversité neutre\fg{} ou \og diversité mathématique\fg{} par exemple).}
et fournissent une revue historique plus lointaine sur les origines de ces mesures. 

\textcite{Dauby2012} écrivent \og diversité au sens strict\fg{}; \textcite{Gregorius2010} \og diversité explicite\fg{}.
...
\begin{itemize}
  \item  $\xq{D}{-\infty}{}{}{}={1}/{\min(p_S)}$ est l'inverse de la proportion de la communauté représentée par l'espèce la plus rare (toutes les autres espèces sont ignorées). 
Le biais d'estimation est incontrôlable: l'espèce la plus rare n'est pas dans l'échantillon tant que l'inventaire n'est pas exhaustif;
  \item  $\xq{D}{0}{}{}{}$ est le nombre d'espèces (alors que $\xq{H}{0}{}{}{}$ est le nombre d'espèces moins 1). C'est la mesure classique qui donne le plus d'importance aux espèces rares: toutes les espèces ont la même importance, quel que soit leur effectif en termes d'individus.
...
Comme les espèces rares sont difficiles à échantillonner, le biais d'estimation est très important, et sa résolution a généré une littérature en soi;
  \item  $\xq{D}{1}{}{}{}$ est l'exponentielle de l'indice de Shannon donne la même importance à tous les individus. 
...
Le biais d'estimation est sensible;
  \item  $\xq{D}{2}{}{}{}$ est l'inverse de l'indice de concentration de Gini-Simpson donne moins d'importance aux espèces rares. 
\textcite{Hill1973} l'appelle \og le nombre d'espèces très abondantes\fg{}. 
...
En conséquence, le biais d'estimation est très petit; de plus, un estimateur non biaisé existe;
  \item  $\xq{D}{\infty}{}{}{}={1}/{d}$ est l'inverse de l'indice de Berger-Parker \autocite{Berger1970} qui est la proportion de la communauté représentée par l'espèce la plus abondante: $d=\max(p_S)$. 
Toutes les autres espèces sont ignorées.
\end{itemize}

Le calcul de $\xq{D}{q}{}{}{}$ peut se faire avec la fonction \code{Diversity} de la librairie \emph{entropart} :
...
L'entropie doit être une fonction concave des probabilités comme on l'a vu plus haut, mais pas la diversité (un exemple de confusion est fourni par \textcite{Gadagkar1989}, qui reproche à $\xq{D}{2}{}{}{}$ de ne pas être concave). 
...
\section{Profils de diversité}

\textcite{Leinster2012}, après \textcite{Hill1973}, \textcite{Patil1982}, \textcite{Tothmeresz1995} et \textcite{Kindt2006}, recommandent de tracer des profils de diversité, c'est-à-dire la valeur de la diversité $\xq{D}{q}{}{}{}$ en fonction de l'ordre $q$ (Figure~\ref{ProfilDivFig}
\verbfootnote{
  Code R :
  <<ProfilDivCode, eval=FALSE>>=
  q.seq <- seq(0, 2, .1)
  ...
  lines(P18D, lty=2)
  @
}) pour comparer plusieurs communautés.
...
\figureSC[t]{ProfilDivFig}
{Profil de diversité calculé pour deux parcelles de Paracou (Parcelle 6: trait plein et Parcelle 18: trait pointillé). 
  La correction du biais d'estimation est celle de Chao et Jost.}
{
  <<ProfilDivFig, echo=FALSE, results='hide'>>=
  <<ProfilDivCode>>
  @
}
...
Ils montrent que des communautés peuvent être séparables en selon un profil de diversité de $\xq{D}{q}{}{}{}$ sans l'être forcément selon un profil de diversité de Hurlbert (page~\ref{sec:Hurlbert}), et inversement.
...
Le profil de la queue de distribution est construit en classant les espèces de la plus fréquente à la plus rare et en traçant la probabilité qu'un individu appartienne à une espèce plus rare que l'espèce en abscisse (Figure~\ref{ProfilQueueFig}
\verbfootnote{
  Code R :
  <<ProfilQueueCode, eval=FALSE>>=
  # Elimination des espèces absentes des deux parcelles
  Psi <- Paracou618.MC$Psi[Paracou618.MC$Ps>0,]
  P6Ps <- sort(Psi[,1])
  P18Ps <- sort(Psi[,2])
  plot(rev(cumsum(P6Ps)), type="l", log="x", xlab="Espèces", ylab="Fréquence")
  lines(rev(cumsum(P18Ps)), lty=2)
  @
}).
...
\figureSC{ProfilQueueFig}
{
  Profil de queue de distribution calculé pour les deux parcelles de Paracou
  (Parcelle 6: trait plein et Parcelle 18: trait pointillé).
  En abscisse: rang de l'espèce dans le classement de la plus fréquente à la plus rare;
  en ordonnée: probabilité qu'un individu de la communauté appartienne à une espèce plus rare.
}
{
  <<ProfilQueueFig, echo=FALSE, results='hide'>>=
  <<ProfilQueueCode>>
  @
}
...
\section{Estimation de l'entropie}
\label{sec:BiaisHCDT}

\subsection{Zhang et Grabchak}

\textcite{Zhang2014} montrent que toutes les mesures d'entropie usuelles sont des combinaisons linéaires de ${\zeta}_{u,v}$ (voir page~\pageref{eq:zeta}). 
\`A partir des estimateurs de ${\zeta}_{u,v}$ \autocite{Zhang2010}, l'estimateur suivant est proposé pour $h_q=\sum^S_{s=1}{p^q_s}$:

\begin{equation}
  \tilde{h}_q = 1+\sum^{\xq{s}{}{n}{\ne 0}{}}_{s=1}{\frac{n_s}{n}\sum^{n-n_s}_{v=1}{\left[\prod^v_{i=1}{\frac{i-q}{i}}\right]\left[\prod^v_{j=1}{\left(1-\frac{n_s-1}{n-j}\right)}\right]}}.
\end{equation}
...
L'estimateur corrigé de $\xq{H}{1}{}{}{}$ est

\begin{equation}
  \xq{\tilde{H}}{1}{}{}{} =\sum^{\xq{s}{}{n}{\ne 0}{}}_{s=1}{\frac{n_s}{n}\sum^{n-n_s}_{v=1}{\frac{1}{v}\left[\prod^v_{j=1}{1-\frac{n_s-1}{n-j}}\right]}}.
\end{equation}

Cet estimateur est différent de $H_z$ \autocite{Zhang2012}.
Il a été également obtenu par d'autres auteurs \autocite{Mao2007, Vinck2012}\autocite[][Annexe S1]{Chao2013} avec d'autres approches. 

Dans \emph{entropart}, utiliser \code{Tsallis} et \code{Diversity} :
...
\subsection{Chao et Jost}

\textcite{Chao2015} complètent cet estimateur par une estimation du biais résiduel, selon la même démarche que pour l'entropie de Shannon \autocite{Chao2013} (voir page~\pageref{eq:Chao2013}).
...
Alors que l'estimateur de Zhang et Grabchak ne prend en compte que les $n-1$ premiers termes de la somme pour un estimateur sans biais, \textcite[][eqn 5]{Chao2015} le complètent par une estimation, forcément biaisée, des termes suivants pour obtenir:

\begin{multline}
  \label{eq:HqChaoJost}
  \xq{\tilde{H}}{q}{}{}{}
  = \frac{1}{q-1} \\
  \left[ 1 -\tilde{h}_q -\frac{\xq{s}{}{}{1}{}}{n} {\left( 1-A \right)}^{1-n} \left( A^{q-1} -\sum^{n-1}_{r=0}{ \binom{q-1}{r} {\left(A-1\right)}^r} \right) \right].
\end{multline}
...
Cet estimateur est le plus performant. Quand $q \to 1$, il tend vers l'estimateur de l'entropie de Shannon de \textcite{Chao2013}, équation~\ref{eq:Chao2013} page~\pageref{eq:Chao2013}. Quand $q=0$, l'estimateur se réduit à Chao1. Pour toutes les valeurs entières de $q$ supérieures ou égales à 2, il se réduit à l'estimateur (\ref{eq:HqZhang}), identique à l'estimateur de Lande pour $q=2$, et est sans biais.

L'estimateur est obtenu à partir de celui du taux de couverture extrapolé (page~\pageref{sec:DefCouverture}) fourni par \textcite[][annexe E]{Chao2012b} sans le détail de la démonstration présenté ici.
...
\begin{equation}
  {\mathbb E}\left(\xq{C}{}{n+m}{}{} | \{n_s\} \right)
  = \xq{C}{}{n}{}{} + \sum_s{p_s [1-(1-p_s)^m] \mathbf{1}(n_s=0)}.
\end{equation}
...
Le deuxième terme de la somme est estimé en posant $\hat{p}_s = \hat{\alpha}_0$ pour toutes les espèces non observées, ce qui constitue la même approximation que pour l'estimation de la relation de Good-Turing, équation~(\ref{eq:GoodTuring2014}) page~\pageref{eq:GoodTuring2014}.
Alors, $\sum_s{p_s}$ est estimé par $\hat{\alpha}_0 {\xq{s}{}{n}{0}{}} = \frac{\xq{s}{}{n}{1}{}}{n}(1 - \hat{\alpha}_1)$ et $(1-p_s)^m$ par $(1-\hat{\alpha}_0)^m$.
...
\begin{eqnarray} 
  {\mathbb E}\left(\xq{C}{}{n+m}{}{} \right)
  & = & 1-\frac{\xq{s}{}{n}{1}{}}{n} 
    \left[ \frac{\left(n-1\right)\xq[]{s}{}{n}{1}{}}{\left(n-1\right)\xq[]{s}{}{n}{1}{}+2\xq[\,]{s}{}{n}{2}{}} \right]^{n+m} \\
  & = & 1-\frac{\xq{s}{}{n}{1}{}}{n} \left( 1-A \right)^{m+1}.
  \label{eq:Cnm}
\end{eqnarray}

L'espérance du taux de couverture est directement liée à l'indice de Simpson généralisé \autocite{Good1953}: ${\mathbb E}(\xq{C}{}{n+m}{}{}) = 1 - \zeta_{1,n+m}$.
L'estimateur de $h_q$ est obtenu en remplaçant les termes $\zeta_{1,k}$ de la somme infinie $\sum_{k=n}^{\infty}{\binom{q-1}{k}(-1)^k \zeta_{1,k}}$ par la valeur de $1 -{\mathbb E}(\xq{C}{}{n+m}{}{})$
calculée dans l'équation~\eqref{eq:Cnm}.
...
\begin{itemize}
  \item  Celle de \textcite{Chao2003}, étendue au-delà de l'entropie de Shannon qui prend en compte les espèces non observées;
  \item  Celle de \textcite{Grassberger1988} qui prend en compte la non-linéarité de l'estimateur.
\end{itemize}

Le domaine de validité des deux corrections est différent. 
Quand $q$ est petit, les espèces rares non observées ont une grande importance alors que $\xq{H}{q}{}{}{}$ est presque linéaire: la correction de Grassberger disparaît quand $q=0$. 
...
Un simple estimateur plug-in, appelé \og estimateur révélé\fg{}, peut ensuite être appliqué à cette distribution révélée \autocite{Marcon2015a}.
...
\subsection{Biais des estimateurs}

\'Etant donné la distribution des probabilités des espèces dans la communauté, l'échantillon 
...
L'erreur quadratique moyenne, somme du carré du biais et de la variance, ou sa racine carrée dont la dimension est celle des données (\foreignlanguage{english}{\emph{root mean square error}}: RMSE), est un bon critère de test \autocite[Voir par exemple][figure 1]{Chao2013}.

\clearpage

\textcite{Haegeman2013} proposent deux estimateurs de la diversité $\xq{D}{q}{}{}{}$ à partir des courbes de raréfaction et d'extrapolation du nombre d'espèces.
Les deux estimateurs bornent la vraie valeur de $\xq{D}{q}{}{}{}$ (leur variabilité n'est pas prise en compte, mais elle est négligeable dans le cadre utilisé).
...
\subsection{Intervalle de confiance des estimateurs}

\`A partir de données d'inventaire, l'estimation du biais est impossible (sinon, le biais serait simplement ajouté à l'estimateur pour le rendre sans biais).
...
L'estimateur naïf de la probabilité d'une espèe observée $s$ est $\hat{p}_s = \nicefrac{n_s}{n}$.
...
Il est obtenu par \textcite{Chao2013} à partir de l'espérance conditionnelle de $\nicefrac{N_s}{n}$:
...
\subsection{Pratique de l'estimation}

La conversion de l'estimateur de l'entropie en estimateur de la diversité pose un nouveau problème puisque $\xq{D}{q}{}{}{}$ n'est pas une transformation linéaire de $\xq{H}{q}{}{}{}$. 
Ce dernier biais peut être négligé \autocite{Grassberger1988} parce que $\xq{H}{q}{}{}{}$, l'entropie, est la valeur moyenne de l'information de nombreuses espèces indépendantes et fluctue donc peu à cause de l'échantillonnage, contrairement aux estimateurs des probabilités.
...
\figureSC{fig:Estimation}
{
  Estimation de la diversité d'une communauté log-normale de 300 espèces.
  Un inventaire de 500 (en bas) ou 5000 (en haut) individus est répété 1000 fois et la diversité estimée à chaque fois par l'estimateur de Chao-Wang-Jost (à gauche) ou l'estimateur révélé (à droite).
  La courbe noire en gras représente la vraie diversité de la communauté.
  La courbe maigre est la moyenne de l'estimation, l'enveloppe grise limitée par les pointillés rouges contient 95\% des valeurs simulées.
}
{
  \subfloat[5000 individus, estimateur de Chao-Wang-Jost]
  {
    \includegraphics[width=0.45\textwidth]{DPlnorm300-5000ChaoWangJost.eps}
  }
  \hfill
  \subfloat[5000 individus, estimateur révélé]
  {
    \includegraphics[width=0.45\textwidth]{DPlnorm300-5000Unveil.eps}
  }
  \\
  \subfloat[500 individus, estimateur de Chao-Wang-Jost]
  {
    \includegraphics[width=0.45\textwidth]{DPlnorm300-500ChaoWangJost.eps}
  }
  \hfill
  \subfloat[500 individus, estimateur révélé]
  {
    \includegraphics[width=0.45\textwidth]{DPlnorm300-500Unveil.eps}
  }
}
...
L'effort d'inventaire simulé est de 500 ou 5000 individus (de l'ordre d'un ou dix hectares pour les arbres de diamètre supérieur ou égal à \SI{10}{cm}).
...
Les fonctions \code{Tsallis} et \code{Diversity }de \emph{entropart} acceptent comme argument un vecteur d'abondances (et non de probabilités) et proposent par défaut la correction de Chao et Jost:
...
\subsection{Raréfaction et extrapolation}
\label{sec:RarExtrapol}

\textcite{Chao2014} étendent l'approche de \textcite{Gotelli2001} aux nombres de Hill et fournissent les méthodes nécessaires au calcul de courbes de raréfaction et d'extrapolation de l'estimateur de $\xq{D}{q}{}{}{}$ en fonction de la taille de l'échantillon ou du taux de couverture.
...
Elles sont en réalité calculées par raréfaction d'un échantillon hypothétique de taille infinie: un estimateur de $\xq{D}{q}{}{}{}$ corrigé du biais d'estimation est nécessaire. 
L'article se limite aux valeurs de $q$ égales à 0, 1 ou 2 ou non entières mais supérieures à 2.
Le package \emph{iNEXT} \autocite{Hsieh2014} implémente ces calculs dans R.



\section{Autres approches}

\subsection{L'entropie de Rényi}
...
Son défaut est qu'elle n'est pas forcément concave \autocite{Beck2009}, ce qui empêche sa décomposition (voir chapitre~\ref{chap:DedompHCDT}, page~\pageref{chap:DedompHCDT}).


\subsection{L'entropie généralisée des mesures d'inégalité}
...
C'est en réalité une entropie relative, qui mesure l'écart entre la distribution observée $\{n_s\}$ et sa valeur moyenne. Elle tend vers l'entropie de Theil quand $q \to 1$ et la moyenne des $\ln(\nicefrac{n_s}{\bar{n_s}})$ quand $q \to 0$.
...
\textcite{Maasoumi1993} explicite cet usage et pour comparer la distribution de probabilité observée $\{q_s\}$ à une distribution attendue $\{p_s\}$, plutôt qu'à la distribution uniforme dont toutes les valeurs seraient $\nicefrac{1}{S}$. En posant $r=q-1$, en transformant les abondances $\{n_s\}$ en probabilités $\{q_s\}$ et en choisissant $\{p_s\}$ arbitrairement, on obtient

\begin{equation}
  H_r\left(\vectorsym{q},\vectorsym{p}\right) = \frac{1}{r\left(r+1\right)}\left[\sum^S_{s=1}{q_s{\left(\frac{q_s}{p_s}\right)}^{r}}-1\right].
\end{equation}


\label{CressieRead}
\textcite{Cressie1984} ont défini une mesure généralisée de qualité d'ajustement (\foreignlanguage{english}{\emph{Goodness of Fit}}) de la distribution $\{q_s\}$ à celle de $\{p_s\}$. 
...
\begin{equation}
  I_r = \frac{1}{q S^{1-q}}\left( \ln_q{S} - \xq{H}{q}{}{}{} \right).
\end{equation}


\subsection{L'entropie de Simpson généralisée}

L'entropie de Simpson généralisée a été introduite dans une classe d'indices plus générale (voir page~\pageref{eq:zeta}) \autocite{Zhang2010} et étudiée en détail par \textcite{Zhang2014}.
...
\begin{equation}
  \xq{D}{r}{\zeta}{}{} = \frac{1}{1 - \zeta_r^{\frac{1}{r}}}.
\end{equation}
...
La figure~\ref{comProfilzeta}
\verbfootnote{Code R pour réaliser la figure:
  <<comProfilzetaCode, eval=FALSE>>=
  # Profil P6
  ...
  # Figure
  plot(zeta18D$x, zeta18D$y, xlim=c(1, S-1), ylim=c(min(zeta6D$low)*.9, 
    max(zeta18D$high)*1.05), xlab = "Ordre de diversité", main="", 
    ylab = "Diversité de Simpson généralisée",
    type="n")
  ...
  CEnvelope(zeta18D, lty=2, LineWidth=2, ShadeColor="NA", col="red", 
            BorderColor="red")
  @
} montre les profils de diversité (en nombre effectifs d'espèces) des deux parcelles 6 et 18 de Paracou: \SI{1}{\hectare} inventorié, respectivement 681 et 483 arbres, pour une richesse estimée à 254 et 309 espèces par les estimateurs jackknife d'ordres 2 et 3:
<<Paracou618S>>=
...
En comparaison, la figure~\ref{comProfilHCDT}
\verbfootnote{Code R pour réaliser la figure:
  <<comProfilHCDTCode, eval=FALSE>>=
  ...
  q.seq=q.seq, Correction="UnveilJ")
  # Figure
  plot(D18$x, D18$y, ylim=c(min(D18$low)*.9, max(D18$high)*1.05),
  xlab = "Ordre de diversité", ylab = "Nombre de Hill", main="", xlim=range(q.seq), type="n")
  ...
  CEnvelope(D18, lty=2, LineWidth=2, ShadeColor="NA", col="red", BorderColor="red")
  @
} montre les profils de diversité HCDT des mêmes parcelles.
Ils se chevauchent pour les petits ordres de diversité, ce qui ne permet pas de conclure.

\figureFW{compProfils}
{Comparaison des profils de diversité des parcelles 6 et 18 de Paracou avec leur intervalle de confiance à 95\%. La parcelle 18 est tracée en rouge, lignes continues, et la 6 en vert, lignes pointillées.}
{
  \subfloat[Diversité généralisée de Simpson (nombres effectif d'espèces). Les profils sont distincts, ce qui permet de conclure que la parcelle 6 est plus diverse que la parcelle 18.\label{comProfilzeta}]
  {
    <<comProfilzetaFig, echo=FALSE, results='hide', message=FALSE, out.width='.45\\maxwidth'>>=
    <<comProfilzetaCode>>
    @
  }
  \hfill
  \subfloat[Diversité HCDT. Les profils se chevauchent jusqu'à $q \approx 0,7$. \label{comProfilHCDT}]
  {
    <<comProfilHCDTFig, echo=FALSE, results='hide', message=FALSE, out.width='.45\\maxwidth'>>=
    <<comProfilHCDTCode>>
    @
  }
}

La distribution statistique de la différence d'entropie est connue, et peut donc être tracée (Figure~\ref{zetaDiffFig}
\verbfootnote{Code R pour réaliser la figure:
  <<zetaDiffCode, eval=FALSE>>=
  # Calcul de P18-P6 avec IC
  Difference <- list(x=zeta18$x, y=zeta18$y-zeta6$y)
  class(Difference) <- class(zeta18)
  icDifference <- qnorm(1-0.05/2)*sqrt(sigma6^2/sum(NsP6) + sigma18^2/sum(NsP18))
  ...
  plot(Difference, xlab = Xlab, ylab=Ylab)
...
\figureSC{zetaDiffFig}
{
  Différence entre les entropies de Simpson généralisées des parcelles 18 et 6 de Paracou avec son intervalle de confiance à 95\%.
  La ligne horizontale représente l'hypothèse nulle d'égalité entre les entropies, qui peut être rejetée.
}
{
  <<zetaDiffFig, echo=FALSE, results='hide'>>=
  <<zetaDiffCode>>
  @
}
...
La mesure normalisée est appelée \foreignlanguage{english}{\emph{case-based entropy}} en anglais et vaut 
\begin{equation}
  \mathit{C_c} = \frac{100 D_c}{\xq{D}{1}{}{}{}}.
\end{equation}

$\mathit{D_c}=\xq{D}{1}{}{}{}$ quand toute la communauté est prise en compte ($c=1$).
Les auteurs s'intéressent principalement à la courbe de $C_c$ en fonction de $c$ pour montrer \autocite{Castellani2016} que la contribution à la diversité totale des 40\% des composants les moints complexes de systèmes très divers (\og des galaxies au gènes \fg{}) atteint toujours au moins 60\%, ce résultat étant interprété comme une loi universelle de limitation de la complexité.

Cette mesure peut être étendue à l'entropie HCDT sans difficulté:
\begin{equation}
  \mathit{\xq{C}{q}{}{c}{}} = {\left(\sum_c{p^q_s}\right)}^{\frac{1}{1-q}}.
\end{equation}
...
Il ne s'agit pas d'une décomposition de la diversité au sens classique du terme (voir partie~\ref{part:Beta}), qui consiste à partitionner la diversité totale en diversité intra et inter-groupes, mais plutôt d'une façon de prendre en compte les caractéristiques des espèces dans une approche non-neutre.



\chapter{\'Equitabilité}
\label{sec:Equitabilite}
...
\lettrine{L}{a régularité} d'une distribution est une notion intuitivement assez simple: la faiblesse de l'écart entre la distribution réelle et une distribution parfaitement régulière \autocite{Lloyd1964}, vérifiant $p_s={1}/{S}$.
...
\begin{itemize}
  \item  L'équitabilité augmente quand un individu est transféré d'une espèce fréquente à une espèce rare;
  \item  L'équitabilité diminue quand une espèce rare est ajoutée;
  \item  Invariance d'échelle: l'équitabilité ne dépend que des fréquences, pas des abondances absolues.
\end{itemize}

\figureSC[t]{Tuomisto2012}
{Courbes de Lorenz de plusieurs jeux de données. 
  Les espèces sont classées par fréquence croissante, et la courbe représente la fréquence cumulée des espèces. 
  Plus la courbe est loin de la bissectrice, plus le jeu de données est inéquitable. 
  Figure extraite de \textcite{Tuomisto2012}.}
{\includegraphics[width=\maxwidth]{Tuomisto2012}}

Un critère supplémentaire établi par \textcite{Smith1996}, complété par \textcite{Gosselin2001} est la compatibilité avec la courbe de \textcite{Lorenz1905}, construite en classant les espèces de la moins fréquente à la plus fréquente, et en traçant le cumul des fréquences en fonction du rang (Figure~\ref{Tuomisto2012}): une communauté parfaitement équitable est représentée par la bissectrice.
La surface entre la courbe réelle et la bissectrice est très utilisée en économie pour mesurer l'inégalité sous le nom d'\og indice de Gini\fg{} \autocite{Gini1912, Ceriani2012}:

\begin{itemize}
  \item  Compatibilité avec la courbe de Lorenz: l'équitabilité augmente pour une communauté si sa courbe de Lorenz est plus proche de la bissectrice. 
...
\begin{itemize}
  \item  Invariance par réplication: l'équitabilité ne change pas si chaque espèce est remplacée par plusieurs nouvelles espèces ayant la même abondance.
\end{itemize}
...
\section{Indice classiques}

\subsection{Indice de Bulla}
...
L'indice de Gini est le double de la surface comprise entre la courbe de Lorenz et la bissectrice (Figure~\ref{Tuomisto2012}).


\subsection{Rapports de moyennes}
...
\section{Indice alternatifs}

\subsection{Variance de la rareté}
...
Alors: $H_{\max}=\ln S$. 
On a donc défini l'indice, souvent appelé \og indice de Pielou\fg{} :
...
\section{Généralisation de l'indice de Pielou}

\subsection{Mendes et al.}
\label{sec:Mendes}
...
\begin{equation}
  \xq{J}{q}{*}{}{} = \frac{\xq{H}{q}{}{}{}}{^{q}H_{\max}} = \frac{\xq{H}{q}{}{}{}}{\ln_q{S}}
\end{equation}

et tracent des profils d'équitabilité, c'est-à-dire la valeur de $\xq{J}{q}{*}{}{}$ en fonction de $q$. 
...
$\xq{J}{2}{*}{}{}$ est l'indice d'équitabilité dérivé de l'indice de diversité de Simpson par \textcite{Hurlbert1971}.

\subsection{Tuomisto}

Tuomisto argumente en faveur d'une définition stricte de l'équitabilité (\foreignlanguage{english}{\emph{evenness}} en anglais, \foreignlanguage{english}{\emph{equitability}} pouvant être utilisé dans un sens plus large) en tant que ratio de Hill:
...
\figureSC{ProfilIneqFig}
{Profil d'inéquitabilité de BCI: L'inéquitabilité augmente quand on néglige de plus en plus les espèces rares. 
  Pour q=2, la forêt de BCI est aussi inéquitable qu'une communauté de 6 espèces dans laquelle une seule serait représentée au-delà d'un nombre négligeable d'individus.}
{
  <<ProfilIneqFig, echo=FALSE, results='hide'>>=
  <<ProfilIneqCode>>
  @
}

\textcite{Jost2010} montre que l'indépendance est impossible dans le cadre de la décomposition multiplicative: si $\xq{E}{q}{}{}{}={\xq{D}{q}{}{}{}/{S}}$, sa valeur minimale est contrainte par le nombre d'espèces, une communauté pauvre ne peut pas être aussi inéquitable qu'une communauté riche (propriété déjà montrée par \textcite{Sheldon1969} ou \textcite{Alatalo1981}).
En revanche, la richesse peut être partitionnée de façon indépendante en diversité et inéquitabilité: $S={\xq{D}{q}{}{}{}}/{\xq{E}{q}{}{}{}}$.

L'inéquitabilité $1/{\xq{E}{q}{}{}{}}$ (Figure~\ref{ProfilIneqFig}
\verbfootnote{
  Code R :
  <<ProfilIneqCode, eval=FALSE>>=
  # Estimation du nombre d'espèces
  Ns <- colSums(BCI)
  UBNs <- jackknife(AbdFreqCount(Ns), k=1)$Nhat
  # Profil
  DivPrf <- CommunityProfile(Diversity, Ns)
  plot(y=UBNs/DivPrf$y, x=q.seq, type="l", col="black",
  lwd=2, xlab="q", ylab="Inéquitabilité", main="")
  @
}
) est un nombre effectif d'espèces: c'est la richesse d'une communauté du même niveau d'équitabilité que la communauté réelle dans laquelle tous les individus (sauf un nombre négligeable) appartiendraient à une seule espèce.
...
\textcite{Jost2010} argumente au contraire en sa faveur: $\xq{E}{q}{}{}{}$ dépend de la richesse et ne peut donc pas être comparé entre communautés de richesse différente. 
Le logarithme de $\xq{E}{q}{}{}{}$ normalisé est une meilleure généralisation de l'indice de Pielou que celle de Mendes et al. :

\begin{equation}
  \xq{J}{q}{}{}{}
  = \frac{\ln\left({\xq{D}{q}{}{}{}}\right)}{\ln S}
  = \frac{\xq{R}{q}{}{}{}}{\ln S}.
\end{equation}

$\xq{J}{q}{}{}{}$ varie entre 0 et 1 et est une transformation monotone de $\xq{E}{q}{}{}{}$ contrairement au $\xq{J}{q}{*}{}{}$ de Mendes et al. 
...
\begin{equation}
  \xq{\tilde{J}}{q}{}{}{} = \frac{\ln\left(e^{\xq{\tilde{H}}{q}{}{}{}}_q\right)}{\ln\tilde{S}}.
\end{equation}


\figureSC{BCIEqFig}
{Profil d'équitabilité de BCI: représentation alternative de la Figure~\ref{ProfilIneqFig}. 
  L'équitabilité est ici normalisée selon Jost.}
{
  <<BCIEqFig, echo=FALSE, results='hide'>>=
  <<BCIEqCode>>
  @
}

Un profil d'équitabilité calculé de cette façon est présenté Figure~\ref{BCIEqFig}
\verbfootnote{
  Code R supplémentaire :
  <<BCIEqCode, eval=FALSE>>=
  plot(y=log(DivPrf$y)/log(UBNs), x=q.seq, type="l", col="black",
  lwd=2, xlab="q", ylab="Indice de Pielou", main="")
  @
}.



\section{Relations empiriques entre richesse et équitabilité}
...
\`A partir d'inventaires de prairies, ils montrent la très faible relation entre les deux valeurs.
...
Ce résultat a été étendu par \autocite{Stirling2001} aux distributions en log-séries et testé dans des communautés réelles avec des conclusions contrastées, notamment des corrélations négatives ntre richesse et équitabilité dans des communautés très riches.

Des simulations permettent de comprendre les corrélations dans des cas simples.
La figure~\ref{SJLogNormale}
\verbfootnote{Code R pour réaliser la figure:
  <<SJLogNormaleHCode, eval=FALSE>>=
  ...
  plot(log(S), H)
  @
  <<SJLogNormaleJCode, eval=FALSE>>=
  # Equitabilité de Pielou
  J <- H/log(S)
  plot(S, J)
  @
  <<SJLogNormaleECode, eval=FALSE>>=
  E <- sapply(rcl, Simpson)
  plot(S, E)
  @
  <<SJLogNormaleJ2Code, eval=FALSE>>=
  J2 <- E/(1-1/S)
  plot(S, J2)
  @
} montre que l'entropie et l'équitabilité sont corrélées positivement à la richesse dans des communautés log-normales de même variance.

\figureFW{SJLogNormale}
{Relation entre l'entropie de Shannon (a), l'indice d'équitabilité de Pielou (b), l'entropie de Simpson (c), l'équitabilité de Hurlbert (d) et la richesse de communautés log-normales similaires (même écart-type des probabilités, seule la richesse varie).}
{
  \subfloat[Entropie de Shannon en fonction de la richesse.\label{SJLogNormaleH}]
  {
    <<SJLogNormaleHFig, echo=FALSE, results='hide', message=FALSE, out.width='.45\\maxwidth'>>=
    <<SJLogNormaleHCode>>
    @
  }
  \hfill
  \subfloat[Indice de Pielou en fonction de la richesse.\label{SJLogNormaleJ}]
  {
    <<SJLogNormaleJFig, echo=FALSE, results='hide', message=FALSE, out.width='.45\\maxwidth'>>=
    <<SJLogNormaleJCode>>
    @
  }
  \\
   \subfloat[Entropie de Simpson en fonction de la richesse\label{SJLogNormaleE}]
  {
    <<SJLogNormaleEFig, echo=FALSE, results='hide', message=FALSE, out.width='.45\\maxwidth'>>=
    <<SJLogNormaleECode>>
    @
  }
  \hfill
  \subfloat[\'Equitabilité de Hurlbert en fonction de la richesse\label{SJLogNormaleJ2}]
  {
    <<SJLogNormaleJ2Fig, echo=FALSE, results='hide', message=FALSE, out.width='.45\\maxwidth'>>=
    <<SJLogNormaleJ2Code>>
    @
  }
}

En revanche, dans une communauté log-normale de richesse fixe mais insuffisamment échantillonnée, les corrélations sont négatives (figure~\ref{NJLogNormale}
\verbfootnote{Code R pour réaliser la figure:
  <<NJLogNormaleHCode, eval=FALSE>>=
  ...
  plot(log(S), H)
  @
  <<NJLogNormaleJCode, eval=FALSE>>=
  # Equitabilité de Pielou
  J <- H/log(S)
  plot(S, J)
  @
  <<NJLogNormaleECode, eval=FALSE>>=
  E <- apply(rmc$Psi, 2, Simpson)
  plot(S, E)
  @
  <<NJLogNormaleJ2Code, eval=FALSE>>=
  J2 <- E/(1-1/S)
  plot(S, J2)
  @
}).
...
\figureFW{NJLogNormale}
{Relation entre l'entropie de Shannon (a), l'indice d'équitabilité de Pielou (b), l'entropie de Simpson (c), l'équitabilité de Hurlbert (d) et la richesse d'échantillons de taille variable d'une même communauté log-normale.}
{
  \subfloat[Entropie de Shannon en fonction de la richesse.\label{NJLogNormaleH}]
  {
    <<NJLogNormaleHFig, echo=FALSE, results='hide', message=FALSE, out.width='.45\\maxwidth'>>=
    <<NJLogNormaleHCode>>
    @
  }
  \hfill
  \subfloat[Indice de Pielou en fonction de la richesse.\label{NJLogNormaleJ}]
  {
    <<NJLogNormaleJFig, echo=FALSE, results='hide', message=FALSE, out.width='.45\\maxwidth'>>=
    <<NJLogNormaleJCode>>
    @
  }
  \\
  \subfloat[Entropie de Simpson en fonction de la richesse\label{NJLogNormaleE}]
  {
    <<NJLogNormaleEFig, echo=FALSE, results='hide', message=FALSE, out.width='.45\\maxwidth'>>=
    <<NJLogNormaleECode>>
    @
  }
  \hfill
  \subfloat[\'Equitabilité de Hurlbert en fonction de la richesse\label{NJLogNormaleJ2}]
  {
    <<NJLogNormaleJ2Fig, echo=FALSE, results='hide', message=FALSE, out.width='.45\\maxwidth'>>=
    <<NJLogNormaleJ2Code>>
    @
  }
}
