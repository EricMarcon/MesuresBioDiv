...
$x$ est le rapport entre les taux de naissance $b$ et de mortalité $d$ dans la métacommunauté, très légèrement inférieur à 1 parce que les espèces existantes sont appelées à disparaître par dérive, et remplacées par les nouvelles espèces: $\nicefrac{b+\nu]{d]=1$.
